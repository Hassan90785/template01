...
class HighlightWeek extends Component {
    render() {
        return (
            <>
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 p-0 m-0">
                    <div className="card ">
                        ...
                        <div className="card-img-overlay img-overlay-black">
                            <p className="card-text card-text-sizing scroll-y-hidden">Match Previews + Week <br/>5 Injury Analysis with Dr. <br/><span className="text-border-bottom">David </span>Chao</p>
                            <br/>
                            <br/>
                        </div>
                    </div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 p-0 m-0">
                    <div className="card ">
                        ...
                        <div className="card-img-overlay img-overlay-red ">
                            <p className="card-text card-text-sizing card-text-position scroll-y-hidden">Match Previews + Week <br/>5 Injury Analysis with Dr. <br/><span className="text-border-bottom">David </span>Chao</p>
                            <p className="card-text card-text-sizing card-text-position-two text-white font-sm ">Lorem Ipsum is simply dummy text of the <br/> printing and typesetting industry.</p>
                            <p className="card-text card-text-sizing  text-white font-sm ">12 October 2020 </p>
