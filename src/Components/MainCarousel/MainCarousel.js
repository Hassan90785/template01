                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-block  text-left pl-md-5 bg-transparent">
                            <span className="bg-primary scroll-y-hidden px-md-2 py-md-1 font-weight-bold">Club</span>
                            ...
                            <p className="bg-transparent mb-0 mb-md-1 color-gray-light font-size">Lorem Ipsum is simply dummy text of the <br/> printing and typesetting industry.</p>
                            <a href=""><span className="bg-transparent pt-md-5 more-link">More</span></a>
                        </div>
                    </div>
